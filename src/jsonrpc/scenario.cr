# i don't think this is going to be used. i thought it might wind up working like
# HTTP::Context, but it seems no after things have fleshed out the way have have.
