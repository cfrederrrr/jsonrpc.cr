...
# `Request` object to be sent to the JSON::RPC server
#
# `P` can be of any type parsable by `JSON::PullParser` and buildable
# with `JSON::Builder`
#
# According to
# [https://www.jsonrpc.org/specification#request_object](JSON::RPC 2.0),
...
class JSON::RPC::Request(P)
  ...
  # A `String` indicating the JSON::RPC version
